...
if (process.env.DEMO === "true") {
  console.log("%cDEMO MODE", "color: red; font-size: 20px; font-weight: bold;");
  ...
  connection.on("message", function (message) {
    ...
    if (message.type === "utf8") {
      ...
      try {
        ...
        if (
          jsonMessage.type === "lightControl" ||
          jsonMessage.type === "zoneLightControl"
        ) {
          if (process.env.DEMO === "false") {
            if (jsonMessage.type === "lightControl") {
              ...
              changeZoneLed(jsonMessage.ledId);
            }
          } else {
...
function changeZoneLed(ledId) {
  const message = "setZone," + ledId;
