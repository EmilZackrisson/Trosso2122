    ...
    return (
      <div className="karta-page">
        <aside className="karta-aside">
          ...
          <button className="btn-primary" id="serialBtn" onClick={serial}>
            Anslut seriell
          </button>
        </aside>
        <section className="karta-section">
          ...
          >
            ...
            <g id="Bostäder_och_Butiker-2" data-name="Bostäder och Butiker-2">
            ...
            <g id="Bostäder_och_Butiker-3" data-name="Bostäder och Butiker-3">
            ...
            <g id="Bostäder_och_Butiker-4" data-name="Bostäder och Butiker-4">
